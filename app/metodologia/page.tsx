...
const steps = [
  ...
  },
  {
    ...
    body:
      "Con esas coberturas sobre la mesa, la IA arma una versión nueva: más limpia, más clara y sin el ruido que suele meter cada línea editorial.",
  },
  {
      ...
      <main className="mx-auto max-w-5xl px-4 py-10">
        <section className="max-w-3xl">
          ...
          <p className="mt-4 text-base leading-relaxed text-muted-foreground">
            ...
            separamos coincidencias de diferencias y publicamos una nota nueva, pensada para leer mejor,
            entender más rápido y depender menos del sesgo de un solo medio.
          </p>
        </section>
